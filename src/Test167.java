...
// List → Vector, ArrayList, ... 가 List 안에 있음
//	- 순서 있음
//	- 배열과 유사
//	- 중복 허용

/*
○ ArrayList 클래스  => 자료구조할 때 적극적으로 써야함
...
public class Test167
{
	public static void main(String[] args)
	{
		...
		// list3 에 list 의 전체 요소 추가 → addAll()
		list3.addAll(list2);
		...
		// list 가 순서대로 접근하기 때문에
		// 역순으로 접근하는 메소드를 포함하고 있다.
		// 출력 → 역순으로 접근
		while (li.hasPrevious())
			System.out.print(li.previous() + " ");
		System.out.println();
		//--==> 어바웃타임 인셉션 스파이더맨 레미제라블 쇼생크탈출1
	} 
}
