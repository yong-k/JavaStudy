...
public class Test142
{
	public static void main(String[] args) throws IOException
	{
		...
		// 『int countTokens()』 : 파싱된 문자열의 개수를 리턴(반환)한다.
		strArr = new String[st.countTokens()];
		//				   ------------------
		//						   4

// 아래 구조 때문에 StringTokenzier 보고 있는거임
// 추후에 배울 collection framework 에서 이런 모양새 많이 보게 될 거임

		n = 0;
		// hasMoreTokens() 가 다음 토큰 있는지 보고
		// 있으면, nextToken() 이 다음 토큰 가져오고
		// 서로 쿵딱쿵딱 하면서 움직이는 것
