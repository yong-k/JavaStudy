...
public class Test099_깊은복사
{
	public static void main(String[] args)
	{
		...
		//int[] copys3 = nums.clone();	// 객체.clone() => 복사해주는 메소드
					// clone() 은 객체설계도에 있다보니까 복사한 대상을 객체 형식으로 반환함
					// 그래서 이렇게 배열 타입으로 반환할 수 없음
					// ==> (int[]) 로 형변환 해줌
				// 혼자 해보니까 (int[]) 안해줘도 됨
				// 아직 Object 클래스 배우기 전이라 쌤이 이렇게 알려주셨나봄
