...
public class Test170
{
	...
	{
		// List도 인터페이스이고, Set도 인터페이스이기 때문에
		// 아래와 같은 방식으로 인스턴스 생성 불가
		// 제네릭 표현식 써도 인터페이스로 인스턴스 생성 불가
		//Set ob = new Set();
		...
		// 우리 출력된 순서대로 자료 넣지 않음 → 순서대로 출력되지 않음
		...
		for(String s : dog)
			System.out.print(s + " ");
		System.out.println();
		//--==> 추가 후 데이터 Set : 시바 셰퍼드 리트리버 시베리안허스키 
		//							치와와 닥스훈트 비숑 말티즈 웰시코기

		// 중복을 허용하지 않는다는 게 중복 입력을 허용하지 않는다는 게 아님
