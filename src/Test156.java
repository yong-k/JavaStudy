...
==========================================================*/
/*
○ 컬렉션 프레임워크(Collection Framework)	=> 그냥 [컬렉션]으로 많이 부름
...
○ 스택 (Stack)
   ...
   Stack 클래스는 오브젝트 후입선출(LIFO: Last Input First Output) 구조의 Stack 을 나타낸다.
   ...
   스택으로 항목을 찾아서 선두로부터 몇 번재인지를 찾아내는 메소드 등이 제공된다.
...
// 배열은 동질의 성격을 가진 데이터를 처리하는데,
// 컬렉션은 동질의 성격을 가지지 않아도 된다.
// 그렇다고 아무거나 막 넣으면, 처리하기 곤란함

//==> 제네릭, 제네릭 표현식
//    '적어도 이 안에 뭐 넣어서 쓸거야' 라고 문법적으로 표시해 두는거 
//  ex) class 컬렉션클래스<String>
//                        ---------> 이런거
