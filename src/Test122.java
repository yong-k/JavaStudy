...
interface CDemo extends ADemo2, BDemo2
{
	// 여기서는 재정의 불가
	// 인터페이스에서 재정의 어떻게 함,, 못함!!
	//public void write();
	//public void print();
...
//	  ↓
// 두 인터페이스(ADemo, BDemo)를 상속받은 인터페이스를 구현한 후 
// 모든 메소드를 재정의한 클래스
class DemoImpl4 implements CDemo
{	
	// ADemo 추상메소드 구현
	@Override
	public void write()
